...
namespace Q1.RedisSyncDataFromDB.Service.DataProviders
{
    ...
    /// </summary>
    public partial class MsSqlCustomDataProvider : BaseDataProvider, ICustomDataProvider
    {
        #region Fields
        ...
        public MsSqlCustomDataProvider(ICustomConnectionInfo customConnectionStringInfo) : base(customConnectionStringInfo)
        {
        }
        ...
        {
            var connectionInfo = GetCurrentConnectionString();

            return new SqlConnectionStringBuilder(connectionInfo);
        }
